...
public class NSGAIIIBuilder<S extends Solution<?>> implements AlgorithmBuilder<NSGAIII<S>> {
    ...
    private String uniformWeightFileName = null;
    ...
    public NSGAIIIBuilder<S> setUniformWeightFileName(String uniformWeightFileName) {
        this.uniformWeightFileName = uniformWeightFileName;
        return this;
    }
    ...
    public String getUniformWeightFileName() {
        return uniformWeightFileName;
    }
