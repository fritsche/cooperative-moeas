 ...
 */
public class MOEADDIslandBuilder extends MOEADBuilder {

    private int migrationFrequency = 1;

    public MOEADDIslandBuilder(Problem<DoubleSolution> problem) {
        super(problem, null);
    }
    ...
    public MOEADDIslandBuilder setMigrationFrequency(int migrationFrequency) {
        this.migrationFrequency = migrationFrequency;
        return this;
    }

    @Override
    public MOEADDIsland build() {
        return new MOEADDIsland(problem, populationSize, resultPopulationSize,
